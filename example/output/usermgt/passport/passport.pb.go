...
import (
	userbase "code.hyfco.com/usermgt/output/usermgt/userbase"
	context "context"
	fmt "fmt"
...
var fileDescriptor_c6b1dee8ab7d8e21 = []byte{
	...
	0x49, 0xce, 0x4f, 0x49, 0x05, 0x1b, 0xc3, 0x1a, 0x04, 0x66, 0x1b, 0x25, 0x71, 0xf1, 0x83, 0x74,
	0x80, 0xd4, 0x06, 0xa7, 0x16, 0x95, 0x65, 0x26, 0xa7, 0x0a, 0xf9, 0x73, 0xb1, 0x82, 0xb5, 0x08,
	0x29, 0xea, 0xe1, 0x70, 0xaf, 0x1e, 0xcc, 0x61, 0x52, 0x84, 0x94, 0x14, 0x17, 0x28, 0x31, 0x38,
	0x09, 0x9c, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x33, 0x1e,
	0xcb, 0x31, 0x24, 0xb1, 0x81, 0xbd, 0x68, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x8d, 0xe4, 0xee,
	0xc2, 0x32, 0x01, 0x00, 0x00,
}
...
func (m *HelloReq) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Info != nil {
		dAtA[i] = 0x12
		i++
		i = encodeVarintPassport(dAtA, i, uint64(m.Info.Size()))
		n1, err1 := m.Info.MarshalTo(dAtA[i:])
		if err1 != nil {
			return 0, err1
		}
		i += n1
